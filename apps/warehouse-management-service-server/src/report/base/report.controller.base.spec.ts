  ...
  test("POST /reports", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dataGenerowania: CREATE_RESULT.dataGenerowania.toISOString(),
      ...
      .expect([
        {
          ...
          dataGenerowania: FIND_MANY_RESULT[0].dataGenerowania.toISOString(),
  ...
  test("GET /reports/:id existing", async () => {
    await request(app.getHttpServer())
      ...
      .expect({
        ...
        dataGenerowania: FIND_ONE_RESULT.dataGenerowania.toISOString(),
