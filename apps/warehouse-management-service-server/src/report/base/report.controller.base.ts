...
export class ReportControllerBase {
  ...
  async uploadLinkDoRaportu(
    ...
    return this.service.uploadLinkDoRaportu(
      {
        where: params,
      },
      Object.assign(file, {
  ...
  async downloadLinkDoRaportu(
    ...
    const result = await this.service.downloadLinkDoRaportu({
      where: params,
    });
  ...
  @common.Delete(":id/linkDoRaportu")
  @swagger.ApiOkResponse({
    type: Report,
  })
  @swagger.ApiNotFoundResponse({
  ...
  async deleteLinkDoRaportu(
    ...
    return this.service.deleteLinkDoRaportu({
      where: params,
    });
  }
}
